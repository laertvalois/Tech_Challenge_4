"""
Página de Predição - Sistema Preditivo de Obesidade
"""
...
def show_prediction_page():
    """Exibe a página de predição"""
    
    st.header("🔮 Predição de Nível de Obesidade")
    st.markdown("""
    Preencha os dados abaixo para obter uma predição do nível de obesidade.
    """)
    ...
    def make_prediction(input_data):
        ...
        try:
            ...
            model = load_trained_model(os.path.join(base_path, 'models/obesity_model.joblib'))
            preprocessor_data = load_preprocessor(os.path.join(base_path, 'models/preprocessor.joblib'))
